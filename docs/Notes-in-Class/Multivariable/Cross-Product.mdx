...
$$
:::
We will try to $\textcolor{#ff66ff}{\text{Derive}}$ this. Here are some useful properties:
:::info[Properties:]
$$
\begin{align}
...
<br/>
<details>
<summary>$\textcolor{#ff66ff}{\text{Derivation}}$</summary>
$$
  \begin{align*}
...
Interestingly, we could $\textcolor{#ff66ff}{\text{Derive}}$ this from our [alternative definition](#alternative-definition). Recall some properties:
...
Since we want $\|\mathbf{u}\|\|\mathbf{v}\|\sin{\theta} = \|\mathbf{u}\times \mathbf{v}\|$, and both side is positive because it is magnitude. Thus, we could alternatively $\textcolor{#ff66ff}{\text{Derive}}$ the squared version:
$$
